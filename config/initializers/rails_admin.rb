# RailsAdmin config file. Generated on June 13, 2014 16:21
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Nasc', 'Admin']
  ...
  # config.excluded_models = ['Admin', 'Article', 'Board', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Admin', 'Article', 'Board', 'User']
